    ...
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
          ...
          <p className="text-xs text-yellow-700">Order Status: {order.orderStatus}</p>
          <p className="text-xs text-yellow-700">Items Count: {order.items?.length || 0}</p>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4">
                {order.items?.map((item, index) => (
                  <div key={item.productId?._id || index} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
