...
function Sidebar({
  ...
  return (
    <aside
      className={`${sidebarCollapsed ? "w-16" : "w-80"} ${darkMode
    ...
    >
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <h3
          className={`text-xs font-semibold uppercase tracking-wider mb-3 ${sidebarCollapsed ? "text-center" : ""
        ...
        {categories.map((category) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center space-x-3 px-3 py-3 rounded-lg transition-all duration-200 group mb-2 ${isActive
      ...
      {!sidebarCollapsed && (
        <div className="p-4 flex-1 overflow-y-auto">
            ...
            <div className="space-y-2">
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  className={`w-full px-2 py-1 text-xs rounded border ${darkMode
          ...
          <div
            ...
            className={`cursor-pointer mb-4 p-3 rounded-lg flex items-center space-x-3 ${darkMode
          ...
          <div className={`mt-6 p-3 rounded-lg ${darkMode
              ? "bg-yellow-900/20 border border-yellow-800"
              : "bg-yellow-50 border border-yellow-200"
            }`}>
            <h4 className={`text-sm font-semibold mb-1 ${darkMode ? "text-yellow-400" : "text-yellow-800"
              }`}>
              Cart Policy
            </h4>
