...
function Sidebar() {
  ...
  // Dummy products for filter example
  const sampleProducts = {
    stationary: [{ id: 1, category: "Stationary" }],
    canteen: [{ id: 2, category: "Canteen" }],
    general: [{ id: 3, category: "General Store" }],
  };

  // Dummy functions
  const getTotalCartItems = () => 3; 
  const getTotalCartValue = () => 750;
  const clearFilters = () => {
